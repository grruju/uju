		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#ztc2sd03001h-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ztc2sd03001h-display": {
								"semanticObject": "ztc2sd03001h",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ztc2sd03001h",
									"url": sap.ui.require.toUrl("ztc2sd03001h")
								}
							}
						}
					}
