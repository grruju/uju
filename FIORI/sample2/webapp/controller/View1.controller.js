sap.ui.define([             //(1)라이브러리를 컨트롤러에서 사용할 때 종속성을 등록해서 사용
     ...
     */
    function (Controller, JSONModel, formatter, grruju, Filter, FilterOperator, Sorter, Fragment, Dialog) {  // (1) define에서 등록한 라이브러리의 이름을 등록해서 내부에서 그 이름 그대로 사용
        "use strict";

        return Controller.extend("sample2.controller.View1", {
