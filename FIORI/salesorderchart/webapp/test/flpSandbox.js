		...
		services: {
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc203salesorderchart-display": {
								"semanticObject": "syncc203salesorderchart",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c203.salesorderchart",
									"url": sap.ui.require.toUrl("sync/c203/salesorderchart")
								}
							}
						}
					}
