		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Viz Frame",
									"targetURL": "#logaligroupwbvizframe-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logaligroupwbvizframe-display": {
								"semanticObject": "logaligroupwbvizframe",
								"action": "display",
								"description": "Viz Frame Chart",
								"title": "Viz Frame",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logaligroup.wbvizframe",
									"url": sap.ui.require.toUrl("logaligroup/wbvizframe")
								}
							}
						}
					}
