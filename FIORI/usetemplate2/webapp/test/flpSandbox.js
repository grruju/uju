		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "차트 템플릿",
									"targetURL": "#sapbtpusetemplate-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpusetemplate-display": {
								"semanticObject": "sapbtpusetemplate",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.usetemplate",
									"url": sap.ui.require.toUrl("sap/btp/usetemplate")
								}
							}
						}
					}
