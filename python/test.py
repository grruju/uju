...
class App:
    def __init__(self, window):
        ...
        self.youtube = self.make_button(self.frame_etc , "테스트",  command=self.job)
    ...
    def job(self):
        ...
        time.sleep(random.uniform(1,2))	# 2~5초 사이 랜덤한 시간으로 슬맆

        # 화면 중앙 선택
        mouseclick(635, 425) 

        # # ## 말하는섬 마을 이동 ###
        autoit.control_click("화상 키보드", "[CLASS:DirectUIHWND]", x=190, y=100)   # M 미니맵 열기
        time.sleep(random.uniform(3,5))	# 랜덤한 시간으로 슬맆
        # mouseclick(43, 131)       # 영지 메뉴 선택
        # time.sleep(random.uniform(2,3))
        # mouse_click(73, 299)      # 말하는섬 선택
        # time.sleep(random.uniform(2,3))
        # mouse_click(103, 349)      # 말하는섬 마을 선택
        # time.sleep(random.uniform(2,3))
        # mouse_click(1129, 707)      # 텔레포트
        # time.sleep(random.uniform(2,3))
        # mouse_click(708, 462)      # 텔레포트 확인 버튼 클릭
        
        # # ## 물약 재정비 ###
        # time.sleep(random.uniform(3,5))	# 랜덤한 시간으로 슬맆
        # mouse_click(1150, 577)   # 마을에서 검색 버튼 활성화
        # time.sleep(random.uniform(2,3))
        # mouse_click(762, 399)   # 상인 찾기
        # time.sleep(random.uniform(2,3))
        # mouse_click(816, 399)   # 잡화상인 찾기
        # time.sleep(random.uniform(13,15))	# 랜덤한 시간으로 슬맆
        # mouse_click(1061, 709)   # 자동구매품목 불러오기
        # time.sleep(random.uniform(2,3))
        # mouse_click(1187, 707)   # 모두 구매
        # time.sleep(random.uniform(2,3))
        # mouse_click(1046, 707)   # 자동구매품목 불러오기
        # time.sleep(random.uniform(2,3))
        # mouse_click(1207, 708)   # 모두 구매
        # time.sleep(random.uniform(2,3))
        # autoit.control_click("화상 키보드", "[CLASS:DirectUIHWND]", x=10, y=35)   # ESC
        # time.sleep(random.uniform(2,3))

        # time.sleep(random.uniform(24,28))	# 2~4초 사이 랜덤한 시간으로 슬맆

        # # ### 즐겨찾기 통해서 던전 진입 ###
        # autoit.control_click("화상 키보드", "[CLASS:DirectUIHWND]", x=190, y=100)   # M 미니맵 열기
        # time.sleep(random.uniform(3,5))
        # mouse_click(35, 243)   # 즐겨찾기 아이콘 클릭
        # time.sleep(random.uniform(2,3))
        # mouse_click(104, 296)   # 첫번째 즐겨찾기 클릭
        # time.sleep(random.uniform(1,2))
        # mouse_click(1127, 711)   # 텔레포트
        # time.sleep(random.uniform(1,2))
        # mouse_click(705, 461)   # 텔레포트

        # # 잠시 휴식
        # time.sleep(random.uniform(2,3))

        # # 자사 시작
        # mouse_click(1194, 502)   # 어시스트 버튼 클릭

        # # # time.sleep(1)
        # # # pyautogui.keyDown('F3')          # 텔레포트
        # # # pyautogui.keyUp('F3')
