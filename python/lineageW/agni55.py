...
class App:
    def __init__(self, window):
        ...
        self.tel_key = Button(self.window, text="key : F3", width=6, bg=self.bg_color["off"], relief="groove", command=self.btn_tel_key)
        self.tel_key.value = "F3"
    ...
    def job(self):
        ...
        time.sleep(random.uniform(7,10))	# 2~5초 사이 랜덤한 시간으로 슬맆
