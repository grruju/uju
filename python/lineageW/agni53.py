...
class App:
    def __init__(self, window):
        ...
        self.youtube = Button(self.window, text="Youtube", width=6, bg=self.bg_color["off"], relief="groove", command=self.job)
    ...
    def job(self):
        ### 마을 귀환 ###
        pyautogui.moveTo(773, 515)       # 영지 메뉴 선택
        pyautogui.click()
        pyautogui.keyDown('8')
        pyautogui.keyUp('8')
        ...
        pyautogui.moveTo(43, 131)       # 영지 메뉴 선택
        pyautogui.click()
        time.sleep(random.uniform(1,2))
        pyautogui.moveTo(79, 302)      # 말하는섬 선택
        pyautogui.click()
        time.sleep(random.uniform(1,2))
        pyautogui.moveTo(111, 353)      # 말하는섬 마을 선택
        pyautogui.click()
        time.sleep(random.uniform(1,2))
        pyautogui.moveTo(1410, 853)      # 말하는섬 마을 이동
        pyautogui.click()
        time.sleep(random.uniform(1,2))
        pyautogui.moveTo(842, 538)      # 텔레포트 확인 버튼 클릭
        pyautogui.click()
